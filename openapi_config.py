...
OPENAPI_TAGS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Admin tokens are required for `/admin/*` routes and `POST /generate-assessment`."
        ),
    },
    {
        "name": "catalog",
...
|------|---------------------|----------|
| **Admin** | `POST /auth/login` with `role: admin` and `password` | All `/admin/*` routes and `POST /generate-assessment` |
