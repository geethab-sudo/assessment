...
EXPECTED_ROUTES: dict[str, set[str]] = {
    ...
    "/client/certificate/by-assessment/share-metadata": {"get"},
    ...
    "/admin/assessment/{assessment_id}/review": {"get"},
    "/admin/assessment/{assessment_id}/review/questions/{question_id}": {"delete"},
    "/admin/assessment/{assessment_id}/review/questions/{question_id}/save": {"post"},
    "/admin/assessment/{assessment_id}/review/publish": {"post"},
    "/admin/assessment/{assessment_id}/alias": {"patch"},
    "/admin/assessment/review/draft": {"post"},
    "/admin/assessment/review/regenerate-question": {"post"},
